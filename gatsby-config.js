...
module.exports = {
  ...
  siteMetadata: {
    ...
    author: `Doug Mellon`,
    authorSite: `https://dougmellon.com`,
    twitterUsername: ``,
    twitterURL: ``,
    linkedInURL: `https://www.linkedin.com/in/douglas-mellon/`,
    githubURL: `https://github.com/dougmellon`,
  },
  plugins: [
    `gatsby-plugin-sass`,
    ...
    // `gatsby-plugin-offline`,
    {
      ...
      options: {
        trackingId: process.env.GOOGLE_ANALYTICS_TRACKNG_ID || "NONE",
        head: false,
      },
    },
    {
